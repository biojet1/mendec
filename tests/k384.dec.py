...
def decrypt(crypto: bytes, n, d):
    return int2bytes(pow(int.from_bytes(crypto, byteorder="big"), d, n))
...
def dec(
    ...
    X=17151144721752592691454397345699920348046828655395009417771084398355581284743421535831549563053393723722491942521739,
):
